...
function onCancel(e) {
  // TODO : when clicking on Cancel button, hide the dialog
...
function onCreate() {
  ...
  let newQuewstion = {}
  hide(dom_questions_dialog)
  newQuewstion.title=document.getElementById('title').value;
  newQuewstion.choiceA=document.getElementById('choiceA').value;
  newQuewstion.choiceB=document.getElementById('choiceB').value;
  newQuewstion.choiceC=document.getElementById('choiceC').value;
  newQuewstion.choiceD=document.getElementById('choiceD').value;
  newQuewstion.correct='A';

  questions.push(newQuewstion)
