    ...
    function getTask(tasks) {
        ...
        <div class="card">
            <div class="card-body">
                ...
                <button type="button" class="btn btn-primary edit-task" data-task-id="${task.id}" data-bs-toggle="modal" data-bs-target="#editTaskModal">
                Edit
            </button>
            <button type="button" class="btn btn-danger delete-task" data-task-id="${task.id}">
             Delete
        </button>
            </div>
        </div>
        ...
        //Code for  submitting edited Task goes here
        ...
        function deleteTask(taskId) {
            axios.delete(url + "/task/" + taskId)
                ...
                alert("You want to delete this task!")
                .catch(err => {
